...
export default class NightsquadPackageView {
  	...
  	constructor(serializedState) {
		...
		/** LOADING PART **/
		this.loading = document.createElement('loading');
		this.lottie_player = document.createElement('div');
		this.lottie_player.innerHTML = '<lottie-player src="https://assets7.lottiefiles.com/temp/lf20_Dyby8d.json"  background="transparent"  speed="1" loop autoplay > </lottie-player>';
		this.loading.appendChild(this.lottie_player);
	}
