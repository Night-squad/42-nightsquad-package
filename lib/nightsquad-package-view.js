...
export default class NightsquadPackageView {
  	...
  	constructor(serializedState) {
		...
		this.loading.innerHTML = '<lottie-player src="https://assets7.lottiefiles.com/temp/lf20_Dyby8d.json"  background="transparent" speed="1" loop autoplay > </lottie-player>';
	}
