...
export default {
  ...
  activate(state) {
	...
	this.nightsquadPackageView.getConnectButton().addEventListener('click', function(){
		var win = window.open("https://api.intra.42.fr/oauth/authorize?client_id=f32234ac42dcf5aa99863dedbe9f5e5e0906795d3115b9ca41d3ce7bf05e89ff&redirect_uri=http%3A%2F%2F42.devdio.fr%2Fapi&response_type=code", "Connection", "width=500,height=720");
