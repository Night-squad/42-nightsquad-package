...
export default class NightsquadPackageView {
	...
	{
		this.homeView.getData().update_data(logtime, location, wallet, eval_point, cursus, blackhole);
	}
	...
	{
		this.homeView.getCoalitions().update_user_coalition(coalition);
	}
	...
	update_xp(xp)
	{
		this.homeView.getXP().update_xp(xp);
	}
