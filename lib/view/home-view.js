'use babel';
import HomeCalendarView from './home/home-calendar-view';
...
export default class HomeView {
	...
	constructor() {
		...
		/** CALENDAR **/
		this.homeCalendarView = new HomeCalendarView();
		...
		this.wrapper.appendChild(this.homeCalendarView.getElement());
